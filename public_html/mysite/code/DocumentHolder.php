...
class DocumentHolder extends Page {
	...
	public function getCMSFields(){
		...
		$gridFieldConfig2->addComponent(new GridFieldSortableRows('Date'));
		
		$gridFieldDocuments = new GridField("Documents", "Documents", $this->Documents()->sort("Date"), $gridFieldConfig2);
