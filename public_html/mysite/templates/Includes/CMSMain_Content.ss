	        ...
	        <div id="navbar" class="">
		        <ul class="nav navbar-nav navbar-right" role="tablist">
					<li class="<% if class == 'CMSPageEditController' %>active<% end_if %>">
						<a href="$LinkPageEdit" title="Form_EditForm" data-href="$LinkPageEdit" role="tab" data-toggle="tab">
							<% _t('CMSMain.TabContent', 'Content') %>
						</a>
					</li>
					<li class="<% if class == 'CMSPageSettingsController' %>active<% end_if %>">
						<a href="$LinkPageSettings" title="Form_EditForm" data-href="$LinkPageSettings" role="tab" data-toggle="tab">>
							<% _t('CMSMain.TabSettings', 'Settings') %>
						</a>
					</li>
					<li class="<% if class == 'CMSPageHistoryController' %>active<% end_if %>">
						<a href="$LinkPageHistory"title="Form_EditForm" data-href="$LinkPageHistory" role="tab" data-toggle="tab">>
