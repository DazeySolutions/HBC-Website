...
<form enctype="multipart/form-data" class="form-stacked form-large-input" id="miniSurveyView<?php  echo $bID; ?>" class="miniSurveyView" method="post" action="<?php  echo $formAction ?>">
