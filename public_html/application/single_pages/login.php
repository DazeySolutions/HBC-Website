...
<div class="login-page">
    <div class="col-sm-6 col-sm-offset-3 login-title text-center">
        <img src="/application/themes/hbc/assets/images/logo.png" style="width: 300px; margin-top:-50px; margin-bottom:-110px;">
    </div>
